...
**Note:** 'Ca' stands for Code Academy. The files were initially all in the root directory of the repo, but I have since moved them into directories based on the Code Academy course structure.
File names up to and including Ca4 follow the name of the exercise in the Code Academy course. From Ca5 onwards, the file names are based on the class name in the exercise.
...
## Ca4_Classes
### Ca4_1_ClassDefintion.java
Defining a class with a main method and highlighting the syntax and scope.

### Ca4_2_Constructors.java
First view of the constructor method and overview of the flow of execution.

### Ca4_3_InstanceFieldsOrVariables.java
Declaring instance fields or variables.

### Ca4_4_ConstructorParameters.java
Passing parameters to the constructor method.

### Ca4_5_AssigningValuesToInstanceFields.java
Using parameters to assign values to instance fields.

### Ca4_6_MultipleFields.java
Using multiple instance fields in a class.

### Ca4_Reivew.java
A review of the basic class exercises including the class definition, constructor method, instance fields, and assigning values to instance fields.

## Ca5_Methods
### Ca5_Store1.java
Introduction to methods and the syntax for declaring methods beyond the main and constructor methods.

### Ca5_Store2.java
Calling methods from the main method.

### Ca5_Store3.java
Exploring the scope of variables and methods.

### Ca5_Store4.java
Using parameters in custom methods.

### Ca5_Store5.java
Calling a method from the main method and printing the resulting change.

### Ca5_Store6.java
Using return in a method. The method no longer uses void and the return type is specified.

### Ca5_Store7.java
Creating and using a custom toString method.

### Ca5_MethodsReview.java
A practical implementation of the methods covered in the previous exercises.

## Ca6_Conditionals
### Order1.java
Introduction to if statements starting with the simplest form.
